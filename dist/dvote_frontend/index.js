...
/***/ "./src/declarations/dvote_backend/dvote_backend.did.js":
/*!*************************************************************!*\
  !*** ./src/declarations/dvote_backend/dvote_backend.did.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/dvote_backend/index.js":
/*!*************************************************!*\
  !*** ./src/declarations/dvote_backend/index.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   dvote_backend: () => (/* binding */ dvote_backend),
/* harmony export */   idlFactory: () => (/* reexport safe */ _dvote_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory)
/* harmony export */ });
...
/* harmony import */ var _dvote_backend_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dvote_backend.did.js */ "./src/declarations/dvote_backend/dvote_backend.did.js");
...
const createActor = (canisterId, options = {}) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_dvote_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
const dvote_backend = canisterId ? createActor(canisterId) : undefined;
...
"use strict";
/*!*****************************************!*\
  !*** ./src/dvote_frontend/src/index.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_dvote_backend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/dvote_backend */ "./src/declarations/dvote_backend/index.js");
...
document.getElementById('register-button').addEventListener('click', async () => {
    ...
    if (username && password) { // Check if username and password are not empty
        try {
            const status = await _declarations_dvote_backend__WEBPACK_IMPORTED_MODULE_0__.dvote_backend.registerUser(username, password);
...
document.getElementById('login-button').addEventListener('click', async () => {
    ...
    const loginSuccessful = await _declarations_dvote_backend__WEBPACK_IMPORTED_MODULE_0__.dvote_backend.loginUser(username, password);
...
document.getElementById('vote-button').addEventListener('click', async () => {
    ...
    if (selectedPartyElement) {
        ...
        _declarations_dvote_backend__WEBPACK_IMPORTED_MODULE_0__.dvote_backend.castVote(username, partyIdentifier).then(voteStatus => {
...
const electionDuration = 180; // 5 minutes
...
async function endElection() {
    try {
        const results = await _declarations_dvote_backend__WEBPACK_IMPORTED_MODULE_0__.dvote_backend.getResults();
